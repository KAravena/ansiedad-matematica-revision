...
::: {.results-lead}
Objetivo 3: Sintetizar dimensiones educativas asociadas, especialmente aprendizaje, rendimiento y experiencia escolar.
:::
...
::: {.synthesis-flow-clean}

::: {.flow-step}
<strong>Condiciones familiares y escolares</strong>
apoyo familiar · apoyo docente · enfoque de enseñanza · oportunidad de aprender · ansiedad parental
:::
...
::: {.flow-step}
<strong>Procesos cognitivos y afectivos</strong>
memoria de trabajo · atención · autoeficacia · engagement · motivación
:::
...
::: {.flow-step}
<strong>Ansiedad matemática</strong>
tensión · miedo · preocupación · evitación · presión
:::
...
::: {.flow-step}
<strong>Resultados educativos</strong>
rendimiento · logro · fluidez aritmética · resolución de problemas · trayectoria matemática
:::
...
::: {.refs-note}
* Artículos del corpus principal de la revisión.
:::
