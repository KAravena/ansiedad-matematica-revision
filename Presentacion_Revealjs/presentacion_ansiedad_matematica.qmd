...
::: {.selection-step}
<span class="flow-number">30</span>
...
<h3>tamizado asistido y priorización</h3>
...
::: {.script-flow}
346 registros únicos → 30 candidatos preliminares
:::

<ul>
<li>Construyó texto de tamizado.</li>
...
## Síntesis del corpus {.results-slide .corpus-integrated-slide}
